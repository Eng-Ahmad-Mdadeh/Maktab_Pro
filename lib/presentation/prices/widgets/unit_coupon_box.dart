...
class UnitCouponBox extends StatelessWidget {
  const UnitCouponBox({super.key, required this.unit});
      ...
      listener: (context, state) {
        if (state.officeApiCallState == OfficesApiCallState.update &&
          ...
          LoadingDialog.show(context);
            ...
            state.selectedOffice?.id == unit.id) {
          LoadingDialog.hide(context);
          context.pushNamed(AppRoutes.unitCouponsScreen, extra: unit);
            ...
            Row(
              ...
              children: [
                ...
                unit.coupons.isNotEmpty
                    ? Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5.v),
                            BodyText(
                              text: '${unit.coupons.length} كوبون',
                              textColor: AppColors.lightBlack,
                            ),
                            SizedBox(height: 5.v),
                    ...
                    : const Expanded(
                        child: BodyText(text: 'لايوجد أكواد خصمم'),
                      ),
                const Align(
