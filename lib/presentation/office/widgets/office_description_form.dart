...
class _OfficeDescriptionFormState extends State<OfficeDescriptionForm> {
  ...
  void initState() {
    ...
    _officeDescriptionController = TextEditingController(text: state.description);
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            const SectionTitle(title: 'اكتب وصف مميز للمكان والخدمه *'),
            InkWell(
              onTap: () {
                showDialog(
                  context: context,
                  builder: (context) {
                    return AlertDialog(
                      content: Column(
                        ...
                        children: [
                          const SectionTitle(title: 'وصف مميز للمكان والخدمة'),
              ...
              child: const SectionTitle(
                title: 'مثال',
                textColor: AppColors.emeraldTeal,
        ...
        Form(
          ...
          child: MaktabTextFormField(
            ...
            onChanged: (value) {
              context.read<OfficeBloc>().add(SetDescriptionEvent(value.trim()));
            },
          ),
        ),
      ],
