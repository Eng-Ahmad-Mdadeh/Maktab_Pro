...
class AdditionalInfoExpansionStatusCubit extends Cubit<bool> {
  AdditionalInfoExpansionStatusCubit() : super(true);
...
class AdditionalInfoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AdditionalInfoExpansionStatusCubit(),
      child: Padding(
        padding: EdgeInsets.only(top: 20.0.v),
        child: BlocBuilder<ContractCubit, ContractEntity>(
          builder: (context, state) {
            return BlocBuilder<AdditionalInfoExpansionStatusCubit, bool>(
              builder: (context, expansionState) {
                return ExpansionTile(
                  title: BodyText(
                    text: "معلومات إضافية",
                    textColor: expansionState ? AppColors.black : AppColors.white,
                  ),
                  onExpansionChanged: context.read<AdditionalInfoExpansionStatusCubit>().toggleStatus,
                  ...
                  children: [
                          ...
                          Column(
                            children: [
                              ...
                              ContractGroupButton<ConditionsType>(
                                ...
                                items: const [
                                  ConditionsType.central,
                                  ConditionsType.window,
                                  ConditionsType.split
                                ],
                                itemsText: [
                    ...
                    ContractGroupButton<PaymentCycleType>(
                      ...
                      items: const [
                        ...
                        PaymentCycleType.quarterlyYearly,
                        PaymentCycleType.midYearly,
                        PaymentCycleType.yearly
                      ],
                      itemsText: [
