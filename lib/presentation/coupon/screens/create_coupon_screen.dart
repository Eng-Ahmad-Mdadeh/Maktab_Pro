...
class _CreateCouponScreenState extends State<CreateCouponScreen> {
  ...
  void initState() {
    ...
    useTimesController =
        TextEditingController(text: widget.coupon?.numberUsed.toString());
    couponDepositController =
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField2(
                          value:
                          context.read<CouponBloc>().state.unit?.id,
                          isDense: true,
                          isExpanded: true,
                          autovalidateMode:
                          ...
                          onChanged: (value) {
                            context.read<CouponBloc>().add(
                                SelectUnitEvent(units.firstWhereOrNull(
                                        (unit) => unit.id == value)!));
                          },
                        ),
                        SizedBox(height: 20.v),
                        ...
                        const BodyText(
                            text:
                            'الخصم سيطبق على تاريخ الوصول وليس تاريخ الحجز'),
                        SizedBox(height: 5.v),
                        MaktabTextFormField(
                          ...
                          onTap: () async {
                            ...
                            if (range != null) {
                              ...
                              couponDateRangeController.value =
                                  TextEditingValue(
                                      text:
                ...
                builder: (context, state) {
                  return state.unit != null
                    ...
                    children: [
                      const SectionTitle(
                          title:
                          'أنواع الاسعار التي يطبق الخصم عليها:'),
                      SizedBox(height: 20.v),
                      SizedBox(
                        height: 60.v,
                  ...
                  child: MaktabButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate() &&
                        ...
                        context.read<CouponBloc>().add(CreateCouponEvent(
                            isUpdate:
                            widget.coupon != null ? true : false,
                            couponId: widget.coupon != null
                                ? widget.coupon!.id
                                : null));
