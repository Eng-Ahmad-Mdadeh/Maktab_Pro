...
class _OfficesScreenState extends State<OfficesScreen> {
  ...
  void initState() {
    ...
    if (context.read<OfficesCubit>().state.myOfficesApiCallState !=
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NavigationCubit, NavigationState>(
      builder: (context, state) {
        return Scaffold(
          appBar: const MaktabAppBar(title: 'المكاتب والوحدات'),
          body: WillPopScope(
            onWillPop: () async {
                ...
                child: BlocBuilder<OfficesCubit, OfficesState>(
                  builder: (context, state) {
                    return ShimmerEffect(
                      isLoading: state.myOfficesApiCallState ==
                          ...
                          Expanded(
                            child: RefreshIndicator(
                              ...
                              child: Column(
                                ...
                                children: [
                                  if (state.myOfficesApiCallState ==
                                      OfficesApiCallState.loading)
